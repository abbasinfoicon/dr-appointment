              ...
              <div className="profile-tab">
                ...
                <div className="profile-personal-info">
                  ...
                  <div className="row mb-4">
                    <div className="col-3">
                      <h5 className="f-w-500">Service Id. <span className="pull-right">:</span></h5>
                    </div>
                    <div className="col-9"><span>{data.service_id}</span>
                    </div>
                  </div>
                  <div className="row mb-4">
                    <div className="col-3">
                      <h5 className="f-w-500">Service Name <span className="pull-right">:</span></h5>
                    </div>
                    <div className="col-9"><span>{data.service_name}</span>
                    </div>
                  </div>
                  <div className="row mb-4">
                    <div className="col-3">
                ...
                <Link href="/dashboard/specialities" className='btn rounded btn-primary'><i className="icon-list"></i> All Lists</Link>
                <Link href={`/dashboard/specialities/edit/${data.service_id}`} className='btn rounded btn-info mx-1'><i className="icon-pencil"></i> Update</Link>
                <button className='btn rounded btn-danger' onClick={() => handleDeletePopup(data.service_id)}><i className="icon-trash"></i> Delete</button>
                <Link href="/dashboard/specialities/add" className='btn rounded btn-primary mx-1'><i className="icon-plus"></i> Add New</Link>
              </div>
            </div>
          </div>
        </div>
